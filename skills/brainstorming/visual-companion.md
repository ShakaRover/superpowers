...
5. **Unload when returning to terminal** — when the follow-on stage doesn't need the browser (e.g., a clarifying question or tradeoff discussion), push a waiting screen to clear stale content:
