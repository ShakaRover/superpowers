...
- Also avoid “下一步” headings that end a turn. If you mention the next task, include its completed review results in the same response; otherwise omit the heading.
