...
# Forbidden prompt phrase list aligned with automation specs.
pattern='auto-accepted and continuing|Auto-accepted and continuing|\\bnext step\\b|\\bnext steps\\b|下一步|继续执行|继续推进|请确认|是否继续|已派发|重新派发|派发|\\bif needed,? i can\\b|\\bif you want,? i can\\b|如果需要'
